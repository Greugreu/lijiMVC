    ...
    <div class="col-md-9">
        <div class="profile-content">
            <form id="contact-form" class="form" action="#" method="POST" role="form">
                ...
                <div class="form-group">
                    <label class="form-label" for="allergiesPlus">Renseigner son ou ses allergies, séparer par une
                                                                  virgule</label>
                    <input type="text"
                           class="form-control"
                           id="allergiesPlus"
                ...
                <div class="form-group">
                    <label class="form-label" for="pathologiePlus">Renseigner sa ou ses pathologies, séparer par une
                                                                   virgule</label>
                    <input type="text"
                           class="form-control"
                           id="pathologiePlus"
                ...
                <div class="form-group">
                    <label class="form-label" for="message">Avez vous des consignes particulières de garderie à donner
                                                            pour l'enfant ?</label>
                    <textarea rows="5"
                              cols="50"
                              name="message"
                              class="form-control"
                              id="message"
                              placeholder="Avez vous des consignes particulières de garderie à donner pour l'enfant ?"
                              tabindex="4"
                              required></textarea>
                </div>
